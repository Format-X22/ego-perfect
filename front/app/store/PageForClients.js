    ...
    data: [
        {
            ...
            description:
                ...
                'Лучше воспринимается людьми, по этой же причине в телефонах используются иконки приложений, ' +
                'а не текстовый список.'
        },
        {
            id: 5,
            ...
            description:
                'Сайт специально оптимизирован под мобильные устройства, ' +
        ...
        },
        {
            ...
            header: 'Интерактив',
            description:
                'Все данные компании разделены на отдельные логические вкладки, ' +
                'вместе являющиеся микро-презентацией компании.'
        },
        {
            id: 4,
